...
char mystring_set_Right[15];     //String data which is to be recieved
...
// Void Loop
void loop() {
  //Serial.readBytes(mystring_set_Right,15);  //Read the serial data
  //RPM_d = float(atoi(mystring_set_Right));
  ...
  //Serial.print("Right Set Point RECEIVER: ");
